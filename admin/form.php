                        ...
                        <div class="main-block">
                            ...
                            <form action="/">
                                <div class="info">
                                    ...
                                    <input type="number" name="nomor_hp" placeholder="Nomor WhatsApp" >
                                ...
                                <div class="metod">
                                    <div> 
                                        <input type="radio" value="Laki-laki" id="radioOne" name="metod" checked/>
                                        <label for="radioOne" class="radio">Laki-laki</label>
                                    </div>
                                <div>
                                    <input type="radio" value="Perempuan" id="radioTwo" name="metod" />
