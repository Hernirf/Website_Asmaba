        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/asmaba.JPG" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/astri.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Asmaba</h4>
                <p>Astri</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/kukang.JPG" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Kukang 2021</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/hut.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Asmaba</h4>
                <p>Warga</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-kegiatan">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/kunjungan3.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Kegiatan</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-kegiatan">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/kunjungan2.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Kegiatan</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-kegiatan">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/kunjungan.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Kegiatan</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/hut2.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Kukang 2021</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="./user/assets/img/portfolio/muah.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Astri</h4>
              </div>
            </div>
